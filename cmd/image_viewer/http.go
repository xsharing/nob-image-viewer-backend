...
func handleHTTPServer(ctx context.Context, u *url.URL, imageViewerEndpoints *imageviewer.Endpoints, wg *sync.WaitGroup, errc chan error, logger *log.Logger, debug bool) {
	...
	for _, m := range imageViewerServer.Mounts {
